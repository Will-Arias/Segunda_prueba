...
if(!empty($_POST)){
    ...
    $sala_archivo=('activo');
  $sql = "SELECT * FROM tblarchivo WHERE documento_usuario LIKE '".$pattern."%' or nombre_usuario LIKE '".$pattern."%' or apellido_usuario LIKE '".$pattern."%';";
        ...
        if($numrows > 0){
            ...
            while($row = $result->fetch_assoc()){
                echo "<tr>".
                    ...
                    "<td>".$row['sala_archivo']."</td>".
                    "<td>".$row['ubicacion_archivo']."</td>".
